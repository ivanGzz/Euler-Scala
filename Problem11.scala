/**
 * Created by Nelson on 3/26/2016.
 *
...
object Problem11 {
    ...
    def getMax(array: Array[Array[Int]], x: Int, y: Int): Int = {
        val horizontal = array(x)(y) * array(x + 1)(y) * array(x + 2)(y) * array(x + 3)(y)
        val vertical = array(x)(y) * array(x)(y + 1) * array(x)(y + 2) * array(x)(y + 3)
        val diagonal0 = array(x)(y) * array(x + 1)(y + 1) * array(x + 2)(y + 2) * array(x + 3)(y + 3)
        val diagonal1 = array(x + 3)(y) * array(x + 2)(y + 1) * array(x + 1)(y + 2) * array(x)(y + 3)
        List(horizontal, vertical, diagonal0, diagonal1).max
    }
    ...
    def main(args: Array[String]): Unit = {
        ...
        println((for (x <- 0 to 16; y <- 0 to 16) yield getMax(array, x, y)).max)
    }
